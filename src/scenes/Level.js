...
class Level extends Phaser.Scene {
	...
	editorCreate() {
		...
		// txt_8
		const txt_8 = this.add.text(390, 1046, "", {});
		txt_8.name = "txt_8";
		txt_8.setOrigin(0.5, 0.5);
		txt_8.text = "Yes";
		txt_8.setStyle({ "align": "center", "fontSize": "80px", "maxLines": 2 });
		txt_8.setWordWrapWidth(1000);
		popup_leave.add(txt_8);

		// txt_9
		const txt_9 = this.add.text(690, 1046, "", {});
		txt_9.name = "txt_9";
		txt_9.setOrigin(0.5, 0.5);
		txt_9.text = "No";
		txt_9.setStyle({ "align": "center", "fontSize": "80px", "maxLines": 2 });
